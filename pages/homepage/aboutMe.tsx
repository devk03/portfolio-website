...
const AboutMe = () => {
  return (
    <div className="px-4">
      <p className="text-6xl sm:text-8xl lg:text-9xl text-center font-extrabold py-4">
        Dev Kunjadia
      </p>
      <p className="font-bold text-2xl sm:text-4xl lg:text-5xl text-center py-4">
        Logician. Athlete. Builder. Artist.
      </p>
      <p className="font-semibold text-xl sm:text-2xl text-center py-4">
